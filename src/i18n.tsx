...
const DICTS: Record<Lang, Dict> = {
  ru: {
    ...
    "pitch.tune": "Подстрой",
    "score.label": "Score",
    "home.subtitle": "Пой в ноту и делись результатом",
    "home.start": "Начать петь",
    "home.leaderboard": "Участники",
    "home.tip": "Совет: используйте наушники для лучшей точности.",
},
  en: {
    "lang.ru": "Русский",
    "lang.en": "English",
    ...
    "pitch.tune": "Tune it",
    "score.label": "Score",
    "home.subtitle": "Sing the note and share your score",
    "home.start": "Start singing",
    "home.leaderboard": "Leaderboard",
    "home.tip": "Tip: use headphones for best accuracy.",
},
};
